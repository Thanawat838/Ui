...
function RadientPaid:Window(text,maincolor)
   ...
   UserImage.Image = "http://www.roblox.com/asset/?id=8803216324"
   ...
   UserName.TextColor3 = Color3.fromRGB(0, 145, 255)
   ...
   UserTag.TextColor3 = Color3.fromRGB(0, 145, 255)
   UserTag.TextSize = 13.000
   UserTag.TextTransparency = 0
   UserTag.TextXAlignment = Enum.TextXAlignment.Left

   UserName.Text = "SHIFT X HUB!"
   UserTag.Text = "#" .. " SHIFT X HUB!"
   ...
   TOOL:Label("LABEL BY CENTERHUB")
--_________[ TOOL ]_____________

    TOOL:Toggle("TOGGLE BY CENTERHUB",false,function(t)

    end)

    TOOL:Button("Button",function()

    end)

    TOOL:Slider("SLIDER",1,100,1,1,function(x)
    
    end)
	
    local dropdoxwn = TOOL:Dropdown("Dropdown",tablexd,"None",false,function(t)
